...
//       const response = await axios.get(`${URL}/facilities/profile/dashboard`, {
//         headers: {
...
//     try {
//       const token = localStorage.getItem('access_token');
//       const response = await axios.get(`${URL}/facilities/profile/bookings?limit=10&status=confirmed`, {
//         headers: {
//           'Authorization': `Bearer ${token}`
//         }
//       });

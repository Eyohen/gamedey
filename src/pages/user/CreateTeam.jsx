...
const CreateTeam = () => {
  ...
  const sportsFormations = {
    'Football': ['4-4-2', '4-3-3', '3-5-2', '4-2-3-1', '5-3-2'],
    'Basketball': ['2-3 Zone', '3-2 Zone', '1-3-1', 'Man-to-Man', 'Full Court Press'],
    'Volleyball': ['6-2', '5-1', '4-2', '6-0'],
    'Baseball': ['Standard 9', 'Modified', 'Softball'],
  ...
  const fetchAvailableSports = async () => {
    try {
      ...
      const response = await axios.get(`${URL}/teams/available-sports`, {
      ...
      setError('Failed to load available sports. Make sure you have confirmed bookings.');
    } finally {
  ...
  const getCurrentSport = () => {
    return availableSports.find(s => s.id === formData.sportId) || availableSports[0];
  };
  ...
  const handleSportSelect = (sport) => {
    const formations = sportsFormations[sport.name] || ['Standard'];
    setFormData(prev => ({
      ...prev,
      sportId: sport.id,
      sport: sport.name,
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      const response = await axios.post(`${URL}/teams`, requestData, {
        headers: { 'Authorization': `Bearer ${token}` }
      });
      ...
      <div className="grid grid-cols-12 gap-8">
        ...
        <div className="col-span-4 space-y-8">
          ...
          <div>
            ...
            <p className="text-gray-600 text-sm mb-4">Select from sports you have booked</p>
            {loadingSports ? (
              ...
              <div className="text-center py-4 text-gray-500">
                ...
                <p className="text-sm mt-2">Make a booking first to create teams</p>
              </div>
            ) : (
          ...
          <div>
            ...
            <div className="mb-6">
              ...
              <div className="relative">
                ...
                {showFormationDropdown && formData.sport && (
                  <div className="absolute top-full left-0 right-0 mt-1 bg-white border border-gray-300 rounded-lg shadow-lg z-10">
                    {(sportsFormations[formData.sport] || ['Standard']).map((formation) => (
                      <button
                        key={formation}

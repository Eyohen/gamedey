...
//pages/Profile.jsx
// MOBILE RESPONSIVE VERSION - User Profile Management Page
import React, { useState, useEffect } from 'react';
import {
  User,
  Mail,
...
const Profile = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 py-4 sm:py-8">
      ...
      <div className="bg-white rounded-lg shadow-md border border-black border-r-[6px] border-b-[4px] p-4 sm:p-6 mb-6">
        <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-6">
          <div className="flex flex-col sm:flex-row items-center sm:items-start space-y-4 sm:space-y-0 sm:space-x-6">
            {/* Profile Picture */}
            <div className="relative">
              <div className="w-20 h-20 sm:w-24 sm:h-24 bg-gradient-to-br from-purple-500 to-blue-500 rounded-full flex items-center justify-center text-white text-xl sm:text-2xl font-bold">
                {profile.profileImage ? (
                  <img 
                    src={profile.profileImage} 
                    alt="Profile" 
              ...
              <button className="absolute bottom-0 right-0 w-6 h-6 sm:w-8 sm:h-8 bg-purple-500 rounded-full flex items-center justify-center text-white hover:bg-purple-600 transition-colors">
            ...
            <div className="text-center sm:text-left">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center sm:justify-start space-y-1 sm:space-y-0 sm:space-x-6 mt-3">
                <div className="flex items-center text-sm text-gray-600">
          ...
          <div className="flex flex-col sm:flex-row space-y-2 sm:space-y-0 sm:space-x-2 w-full lg:w-auto">
            {editing ? (
              <>
                <button
                  onClick={updateProfile}
                  className="w-full sm:w-auto bg-green-500 text-white px-4 py-2 rounded-lg hover:bg-green-600 transition-colors flex items-center justify-center"
                >
                  <Save size={16} className="mr-2" />
                  Save
                </button>
              ...
              <button
                onClick={() => setEditing(true)}
                className="w-full sm:w-auto bg-purple-500 text-white px-4 py-2 rounded-lg hover:bg-purple-600 transition-colors flex items-center justify-center"
              >
                <Edit size={16} className="mr-2" />
                Edit Profile
              </button>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
        ...
        <div className="xl:col-span-2 space-y-6">
          {/* Basic Info */}
          <div className="bg-white rounded-lg shadow-md border border-black border-r-[6px] border-b-[4px] p-4 sm:p-6">
            <h2 className="text-lg font-semibold text-gray-900 mb-4">Personal Information</h2>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <p className="px-3 py-2 bg-gray-100 rounded-lg text-gray-600 flex items-center">
                  ...
                  <span className="truncate">{profile.email}</span>
                  <span className="ml-2 text-xs text-green-600 flex-shrink-0">Verified</span>
                </p>
              </div>
            </div>
          </div>

          {/* Location Information - Mobile Responsive */}
          <div className="bg-white rounded-lg shadow-md border border-black border-r-[6px] border-b-[4px] p-4 sm:p-6">
            <h2 className="text-lg font-semibold text-gray-900 mb-4">Location</h2>
              ...
              <div className="sm:col-span-2 lg:col-span-1">
                ...
                {editing ? (
                  ...
                  <p className="px-3 py-2 bg-gray-50 rounded-lg flex items-center">
                    ...
                    <span>{profile.location?.country || 'Not provided'}</span>
                  </p>
                )}
              </div>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                <div className="flex items-start sm:items-center">
                  <Bell size={18} className="mr-3 text-gray-500 mt-1 sm:mt-0 flex-shrink-0" />
                  <div>
                    <p className="font-medium text-gray-900">Push Notifications</p>
                    <p className="text-sm text-gray-500">Receive notifications about bookings and updates</p>
                  </div>
              ...
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                <div className="flex items-start sm:items-center">
                  <Mail size={18} className="mr-3 text-gray-500 mt-1 sm:mt-0 flex-shrink-0" />
                  <div>
                    <p className="font-medium text-gray-900">Email Updates</p>
                    <p className="text-sm text-gray-500">Receive email updates about new features and promotions</p>
                  </div>
              ...
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                <div className="flex items-start sm:items-center">
                  <Phone size={18} className="mr-3 text-gray-500 mt-1 sm:mt-0 flex-shrink-0" />
                  <div>
                    <p className="font-medium text-gray-900">SMS Updates</p>
                    <p className="text-sm text-gray-500">Receive SMS notifications for important updates</p>
                  </div>

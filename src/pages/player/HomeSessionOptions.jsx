  ...
  return (
    <div className="container mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div className="mb-6 sm:mb-8">
        ...
        <div className="flex items-center gap-2 sm:gap-4 mb-2">
          ...
          <div className="flex-1 min-w-0">
            <h1 className="text-xl sm:text-2xl lg:text-3xl font-bold">Home Session</h1>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6 max-w-3xl">
        {/* Individual Session */}
        <div
          onClick={() => navigate(`/home-session/${sportId}`)}
        ...
        >
          ...
          <p className="text-sm sm:text-base text-gray-600">Book a single home session — pick a coach to train at your location</p>
        </div>

        {/* Session Packages */}
        <div
          onClick={() => navigate(`/sport/${sportId}/home-packages`)}
          className="cursor-pointer bg-white rounded-2xl p-6 sm:p-8 hover:shadow-xl transition-all hover:scale-[1.02] border border-black border-r-[6px] border-b-[4px]"
        >
          ...
          <p className="text-sm sm:text-base text-gray-600">Save more with bundled home sessions — multiple sessions at a discounted price</p>
        </div>
      </div>
    </div>
  );
...
export default HomeSessionOptions;
